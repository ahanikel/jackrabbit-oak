...
/**
 * {@code CheckpointMBean} implementation for the {@code ZeroMQNodeStore}.
 */
public class ZeroMQCheckpointMBean extends AbstractCheckpointMBean {
    private final Logger log = LoggerFactory.getLogger(getClass());
    private final ZeroMQNodeStore store;

    public ZeroMQCheckpointMBean(ZeroMQNodeStore store) {
        this.store = store;
    }
