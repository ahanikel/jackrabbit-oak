...
public final class MergingNodeStateDiff extends DefaultNodeStateDiff {
    ...
    public MergingNodeStateDiff(NodeState parent, NodeBuilder target, ThreeWayConflictHandler conflictHandler) {
        this.parent = parent;
        this.target = target;
        this.conflictHandler = conflictHandler;
    }

    public static NodeState merge(NodeState fromState, NodeState toState, ThreeWayConflictHandler conflictHandler) {
        return merge(fromState, toState, toState.builder(), conflictHandler).getNodeState();
    }

    public static NodeBuilder merge(NodeState fromState, NodeState toState, NodeBuilder target,
