 ...
 * TODO: I don't know yet what this is about so I just copied it from SegmentDiscoveryLiteDescriptors
 **/
class SimpleDiscoveryLiteDescriptors implements Descriptors {
    ...
    SimpleDiscoveryLiteDescriptors(NodeStore store) {
        this.store = store;
    }
