...
description = "Run the blob reader service")
public class BlobReaderCommand implements Runnable {
  ...
  public void run() {
    try {
      ...
      new SimpleBlobReaderService(blobStore, sendingUri, receivingUri).run();
    } catch (Exception e) {
